...
function mapDispatchToProps(dispatch) {
  return {
    actions: bindActionCreators({saveMusic, getSongs, play: playFromSongs, toggle}, dispatch),
  };
}
...
export default class Songs extends Component {
  ...
  isPlaying = (track) => {
    if (this.props.player) {
      ...
      return currentlyPlaying.spotify_id === track.spotify_id && this.props.player.isPlaying;
    }
    return false;
  };
